                ...
                <div className="lg:w-[1260px] lg:mx-auto bg-gray-100 text-gray-900 lg:flex ">
                    <div className="lg:w-[550px] lg:px-10 bg-blue-900">
                        <div className="relative lg:mx-1 p-4 lg:pt-5 lg:h-[410px] lg:w-[580px]">
                            ...
                            <button
                                className="next absolute bottom-2 left-2 text-white p-2"
                                onClick={prevSlide}
                            >
                                &#10094; Prev /
                            </button>
                            <button
                                className="prev absolute bottom-2 left-16  text-white  p-2"
                                onClick={nextSlide}
                            >
                                Next &#10095;
                            </button>
                    ...
                    <div className="px-5 lg:px-10">
                        <div className='space-y-6 py-5 md:pt-10 lg:pt-14 ml-0 md:ml-14 lg:ml-20'>
                            <div className='text-3xl md:text-5xl lg:text-5xl font-bold'>
                                Visit Our Campus <br/> with Image Gallery
                            </div>
