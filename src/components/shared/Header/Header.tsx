  ...
  return (
    <header className="bg-white shadow-md pb-1">
      <div className="flex item-center justify-center text-center content-center ">
        <Image src={headerImg} alt="" className="h-[140px] w-[1140px] pt-5 pb-8"/> 
      </div>
      <nav 
        className="mx-auto flex max-w-6xl items-center justify-between p-4 lg:px-5 bg-gray-100 rounded-full mb-2"
        aria-label="Global"
      >       
