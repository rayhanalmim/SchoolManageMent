                ...
                <div className=" bg-white-100  text-gray-800">
                    <div className="py-5 md:py-8 lg:py-8">
                        ...
                        <div className="grid grid-cols-3 md:grid-cols-5 lg:grid-cols-5 px-0 md:px-5 lg:px-8 text-center items-center text-xs md:text-base lg:text-xl">
                            <button className="p-2 md:py-8 lg:pb-4 border-b-[2px] border-r-[2px]" onClick={openModal}>KG</button>
                            {dialog} 
                            <button className="p-2 md:py-8 lg:pb-4 border-b-[2px] border-r-[2px]" onClick={openModal}>Play Ground</button>
                            {dialog}
                            <button className="p-2 md:py-8 lg:pb-4 border-b-[2px] lg:border-r-[2px]" onClick={openModal}>Class 1</button>
                            {dialog}
                            <button className="p-2 md:py-8 lg:pb-4 border-b-[2px] border-r-[2px]" onClick={openModal}>Class 2</button>
                            {dialog}
                            <button className="p-2 md:py-8 lg:pb-4 border-b-[2px] border-r-[2px] md:border-r-[0px] lg:border-r-[0px] " onClick={openModal}>Class 3</button>
                            {dialog}
                            <button className="p-2 md:py-8 lg:pb-4 border-b-[2px] lg:border-r-[2px]" onClick={openModal}>Class 4</button>
                            {dialog}
                            <button className="p-2 md:py-8 lg:pb-4 border-b-[2px] border-r-[2px]" onClick={openModal}>Class 5</button>
                            {dialog}
                            <button className="p-2 md:py-8 lg:pb-4 border-b-[2px] border-r-[2px]" onClick={openModal}>Class 6</button>
                            {dialog}
                            <button className="p-2 md:py-8 lg:pb-4 border-b-[2px] lg:border-r-[2px]" onClick={openModal}>Class 7</button>
                            {dialog}
                            <button className="p-2 md:py-8 lg:pb-4 border-b-[2px] border-r-[2px] md:border-r-[0px] lg:border-r-[0px]" onClick={openModal}>Class 8</button>
                            {dialog}
                            <button className="p-2 md:py-8 lg:pb-4 border-b-[2px] md:border-b-[0px] lg:border-b-[0px] border-r-[2px]" onClick={openModal}>Class 9</button>
                            {dialog}
                            <button className="p-2 md:py-8 lg:pb-4 border-b-[2px] md:border-b-[0px] lg:border-b-[0px] lg:border-r-[2px] " onClick={openModal}>Class 10</button>
                            {dialog}
                            <button className="p-2 md:py-8 lg:pb-4 border-r-[2px]" onClick={openModal}>Class 11</button>
                            {dialog}
                            <button className="p-2 md:py-8 lg:pb-4 border-r-[2px]" onClick={openModal}>Class 12</button>
                            {dialog}
                        </div>
                    </div>
                </div>
