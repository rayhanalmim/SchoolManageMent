        ...
        <div className=" lg:w-[1260px] mx-auto md:flex lg:flex  lg:justify-between items-center mt-5 md:mt-14 lg:mt-14 mb-5 md:mb-48 lg:mb-48 text-center md:text-left lg:text-left">
            <div className="lg:w-[500px] mx-5 md:mx-5 lg:mx-0 mb-4 md:mb-0 lg:mb-0">
             ...
             <div className="w-auto md:mr-14 lg:mr-14">
                <div>
                    <Image src={envir5} className="h-auto w-auto ml-10 md:-ml-[230px] lg:-ml-[230px] mt-[50px] md:mt-[150px] lg:mt-[100px] smallImg" alt="this is img" />
                </div>
                <div>
                    <Image src={envir6} className="h-auto w-auto -mt-[40px] md:-mt-[150px] lg:-mt-[150px] ml-[220px] md:ml-[25px] lg:ml-[25px] smallImg" alt="this is img" />
                </div>
                ...
                <div className="mt-[70px] md:-mt-[100px] lg:-mt-[100px] flex flex-col ">
                    <div>
                        ...
                        <Image src={envir4} className="h-[160px] sm:h-[200px] md:h-auto lg:h-auto w-auto rotate-45 rounded-xl ml-10 sm:ml-14 md:-ml-[139px] lg:-ml-[139px] md:-mt-[125px] lg:-mt-[125px]  imgResponsive" alt="this is img" />
                    </div>
                    <div>
                        ...
                        <Image src={envir1} className="h-[160px] sm:h-[200px] md:h-auto lg:h-auto w-auto rotate-45 rounded-xl  ml-[50px] md:ml-0 lg:ml-0 md:-mt-[290px] lg:-mt-[290px] imgResponsive" alt="this is img" />
                    </div>
                    <div>
                        <div className='bg-green-600 lg:h-[190px] lg:w-[190px] rotate-45 rounded-xl lg:-ml-[270px] lg:-mt-[180px]'></div>
                        <Image src={envir3} className="h-[160px] sm:h-[200px] lg:h-auto w-auto rotate-45 rounded-xl lg:-ml-[250px] ml-10 sm:ml-14 lg:-mt-[190px] imgResponsive" alt="this is img" />
                    </div>
                    <div>
                        <div className='bg-[#27b8a7] lg:h-[225px] lg:w-[225px] rotate-45 rounded-xl lg:-ml-[120px] lg:-mt-[3px]'></div>
                        <Image src={envir2} className="h-[160px] sm:h-[200px] lg:h-auto w-auto rotate-45 rounded-xl lg:-ml-[120px] ml-10 sm:ml-14 lg:-mt-[249px] imgResponsive" alt="this is img" />
                    </div>
                </div>  
                {/* ------------------------------ */}
