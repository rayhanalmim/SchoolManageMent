...
import schoolImg from "../../../../public/assests/s1.jpg"
  ...
  return (
    <div className="lg:w-auto pb-5 mx-auto ">
      ...
      <div className="lg:w-auto border rounded p-4 bg-white ">
        ...
        <div className="my-10">
          <h2 className="font-bold text-4xl text-center">Our History</h2>
          <div className="carousel w-[600px] h-[300px] mt-5">
            <div id="slide1" className="carousel-item relative w-full">
              {/* <img src="https://daisyui.com/images/stock/photo-1625726411847-8cbb60cc71e6.jpg" className="w-full" />  */}
              {/* <Image src={schoolImg} className="h-auto w-auto rounded" alt="img" />  */}
              <div className="h-auto rounded px-20">
                <div className="flex gap-4">
                  <h2 className="text-4xl font-bold">2024</h2>
                  <p>Tealium processes over 9 billion events on a typical day and launches Mosaic and LIFT University.
                    <br /><br />
                    700 team members and growing!</p>
                </div>
                <Divider />
                <div className="flex gap-4">
                  <h2 className="text-4xl font-bold">2023</h2>
                  <p>Tealium becomes a remote first company in response to the Covid-19 pandemic. Later in the year, Tealium Predict is launched.
                    <br /><br />
                    500 team members in 16 countries and customers in 30+</p>
                </div>
              </div>
            ...
            <div id="slide3" className="carousel-item relative w-full">
              ...
              <div className="h-auto  rounded px-20">
                <div className="flex gap-4">
                  <h2 className="text-4xl font-bold">2016</h2>
                  <p>EventStream & DataAccess are added to Tealium’s product offerings.</p>
                </div>
                <Divider />
                <div className="flex gap-4">
                  <h2 className="text-4xl font-bold">2013</h2>
                  <p>Tealium launches the first ever Customer Data platform, AudienceStream.<br /><br />
            ...
            <div id="slide4" className="carousel-item relative w-full">
              ...
              {/* <Image src={schoolImg} className="h-auto w-full rounded" alt="img" /> */}
              <div className="h-auto rounded px-20">
                <div className="flex gap-4">
                  <h2 className="text-4xl font-bold">2012</h2>
                  <p>Tealium’s first product, iQ Tag Management launches, followed by the Multi-CDN network.</p>
                </div>
                <Divider />
                <div className="flex gap-4">
                  <h2 className="text-4xl font-bold">2008</h2>
                  <p>Tealium founded by Mike Anderson and Ali Behnam.</p>
                </div>
        ...
        <section className="py-6   text-gray-800">
          <div className="container p-4 mx-auto space-y-16 sm:p-10">
            ...
            <div className="grid w-full grid-cols-1 gap-x-3 gap-y-12 sm:grid-cols-2 lg:grid-cols-3  ">
              <div className="space-y-4 shadow-lg rounded border py-3">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-sm  text-gray-600">Bangla</p>
              ...
              <div className="space-y-4  shadow-lg rounded border py-3">
                ...
                <div className="flex flex-col items-center">
                  <h4 className="text-xl font-semibold">Leroy Jenkins</h4>
                  <p className="text-sm  text-gray-600">ICT</p>
                  <div className="flex mt-2 space-x-2">
                    <a rel="noopener noreferrer" href="#" title="Twitter" className=" text-gray-600">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" fill="currentColor" className="w-4 h-4">
                        <path d="M 50.0625 10.4375 C 48.214844 11.257813 46.234375 11.808594 44.152344 12.058594 C 46.277344 10.785156 47.910156 8.769531 48.675781 6.371094 C 46.691406 7.546875 44.484375 8.402344 42.144531 8.863281 C 40.269531 6.863281 37.597656 5.617188 34.640625 5.617188 C 28.960938 5.617188 24.355469 10.21875 24.355469 15.898438 C 24.355469 16.703125 24.449219 17.488281 24.625 18.242188 C 16.078125 17.8125 8.503906 13.71875 3.429688 7.496094 C 2.542969 9.019531 2.039063 10.785156 2.039063 12.667969 C 2.039063 16.234375 3.851563 19.382813 6.613281 21.230469 C 4.925781 21.175781 3.339844 20.710938 1.953125 19.941406 C 1.953125 19.984375 1.953125 20.027344 1.953125 20.070313 C 1.953125 25.054688 5.5 29.207031 10.199219 30.15625 C 9.339844 30.390625 8.429688 30.515625 7.492188 30.515625 C 6.828125 30.515625 6.183594 30.453125 5.554688 30.328125 C 6.867188 34.410156 10.664063 37.390625 15.160156 37.472656 C 11.644531 40.230469 7.210938 41.871094 2.390625 41.871094 C 1.558594 41.871094 0.742188 41.824219 -0.0585938 41.726563 C 4.488281 44.648438 9.894531 46.347656 15.703125 46.347656 C 34.617188 46.347656 44.960938 30.679688 44.960938 17.09375 C 44.960938 16.648438 44.949219 16.199219 44.933594 15.761719 C 46.941406 14.3125 48.683594 12.5 50.0625 10.4375 Z"></path>
