                        ...
                        <div className="lg:w-auto lg:mt-2  ">
                            ...
                            <section className=" lg:w-auto border rounded p-4 bg-white text-gray-800">
                                <div className="container max-w-xl px-6 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
                                    <div>
                                        {/* <h2 className="text-3xl font-bold tracking-tight text-center sm:text-5xl  text-gray-900">SoftyEdu Scout Group</h2> */}
                                        <Image
                                            src={scoutimg}
                                    ...
                                    <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center text-justify">
                                        <div>
                                            {/* <h3 className="text-2xl font-bold tracking-tight sm:text-3xl  text-gray-900">SoftyEdu স্কাউট গ্রুপ</h3>
                                            <p className="mt-3 text-lg  text-gray-600">স্কাউটিং-এর মূল লক্ষ্য হচ্ছে শিশু, কিশোর-কিশোরীদের শারীরিক, মানসিক, নৈতিক, বুদ্ধিবৃত্তিক এবং সামাজিক গুণাবলী উন্নয়নের মাধ্যমে তাদেরকে পরিবার, সমাজ, দেশ তথা বিশ্বের সুনাগরিক হিসেবে গড়ে তোলা।</p> */}
                                            <div className="mt-12 space-y-12">
                                                <div className="flex">
                                                    ...
                                                    <div className="ml-4">
                                                        ...
                                                        <p className="mt-2  text-gray-600">স্কাউট গ্রুপ ২০০১ সালের ১৮ ফেব্রুয়ারি বাংলাদেশ স্কাউটস, ঢাকা মেট্রোপলিটনের ৩৮০ নং দল হিসেবে বাংলাদেশ স্কাউটস, ঢাকা অঞ্চলের রেজিস্টারভুক্ত হয়।</p>
                                                    </div>
                                                </div>
                                                <div className="flex">
                                                    <div className="flex-shrink-0">
                                                    ...
                                                    <div className="ml-4">
                                                        ...
                                                        <p className="mt-2  text-gray-600">সভাপতি : প্রিন্সিপাল মো. মাহবুবর রহমান মোল্লা<br />
                                                ...
                                                <div className="flex">
                                                    ...
                                                    <div className="ml-4">
                                                        ...
                                                        <p className="mt-2  text-gray-600">শাখা: কাব স্কাউট,  স্কাউট,  রোভার স্কাউট</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="grid gap-4 mx-4 sm:grid-cols-12">
                                                <div className="col-span-12 sm:col-span-5">
                                                    <div className="text-center sm:text-left mb-14 before:block before:w-24 before:h-3 before:mb-5 before:rounded-md before:mx-auto sm:before:mx-0 before:bg-violet-600">
                                                        <h3 className="text-3xl font-semibold">একনজরে আমাদের অর্জন</h3>
                                                ...
                                                <div className="relative col-span-12 px-4 space-y-6 sm:col-span-7">
                                                    <div className="col-span-12 space-y-12 relative px-4 sm:col-span-8 sm:space-y-8 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:bg-gray-300">
                                                        <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-violet-600">
                                                            <h3 className="text-xl font-semibold tracking-wide">২০২১ সালে জাতীয় অ্যাওয়ার্ড: </h3>
                                ...
                                <div  >
                                    ...
                                    <section className="py-6  text-gray-900">
                                        <div className="container grid grid-cols-2 gap-4 p-4 mx-auto md:grid-cols-4">
                                            ...
                                            <Image src={scout5} className="w-full h-full rounded shadow-sm min-h-48  bg-gray-500 aspect-square" alt="img" />
                                            <Image src={scout1} className="w-full h-full rounded shadow-sm min-h-48  bg-gray-500 aspect-square" alt="img" />
                                            <Image src={scout2} className="w-full h-full rounded shadow-sm min-h-48  bg-gray-500 aspect-square" alt="img" />
                                            <Image src={scout3} className="w-full h-full rounded shadow-sm min-h-48  bg-gray-500 aspect-square" alt="img" />
                                            <Image src={scout4} className="w-full h-full col-span-2 row-span-2 rounded shadow-sm min-h-96 md:col-start-1 md:row-start-3  bg-gray-500 aspect-square" alt="img" />
                                        </div>
                                    </section>
                                </div>
                            </section>
