            ...
            <div className="w-auto lg:mt-2 px-2">
              ...
              <section className="w-auto border rounded p-4 bg-white text-gray-800 lg:px-16 my-4 md:my-0 lg:my-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:gap-4">
                  ...
                  {selectedExam !== "Mid Term" && selectedExam !== "Final" && (
                    <label className="form-control w-full max-w-xs">
                      <div className="label">
                ...
                <div className="flex flex-col items-center justify-center">
                  <button className="btn btn-neutral md:btn-wide lg:btn-wide mt-5">
                    Submit
                  </button>
                </div>
              </section>
              ...
              <section className="lg:w-full border rounded p-1 md:p-2 lg:p-4 bg-white text-gray-800 lg:gap-4 lg:mt-5 lg:px-20 lg:py-6">
                  ...
                  <table className="border-collapse border border-gray-400 lg:w-full mx-auto">
                    <thead>
                      <tr className="bg-gray-100 text-center">
                        <td className="border border-gray-400 p-[2px] md:p-1p-2">
                          Roll No.
                        </td>
                        <td className="border border-gray-400 p-[2px] md:p-2 lg:p-2">
                          12345
                        </td>
                        <td className="border border-gray-400 p-[2px] md:p-2 lg:p-2">
                          Class
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td
                          className="border border-gray-400 p-[2px] md:p-2 lg:p-2"
                          colSpan={3}
                        >
                          Mr. Chamal{" "}
                        </td>
                ...
                {/* second section */}
                <h2 className="text-xl md:text-2xl lg:text-2xl text-center py-5">
                  ...
                  <table className="border border-gray-400 lg:w-full mx-auto">
                    <tbody>
                      ...
                      {tables.map((items, index) => (
                        <tr key={items.name}>
                          <td
                            className={`border border-gray-400 p-[2px] md:p-2 lg:p-2 text-center ${
                          ...
                          <td
                            className={`border border-gray-400 p-[2px] md:p-2 lg:p-2 uppercase ${
                              index % 2 === 0 ? "bg-gray-200" : ""
                            }`}
                          >
                            {items.name}
