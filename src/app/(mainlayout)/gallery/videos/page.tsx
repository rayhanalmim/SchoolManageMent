            ...
            <div className="lg:w-auto lg:mt-2  ">
              ...
              <section className="lg:w-auto border rounded p-2 md:p-4 lg:p-4 bg-white text-gray-800 mb-5 md:mb-0 lg:mb-0">
                <div className="lg:w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-5 mx-auto">
                  <iframe className="videos lg:h-[315px] w-[460px] " src="https://www.youtube.com/embed/xz6YlRulM3A?si=StnMtUwU5zgXPB6z" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                  <iframe className="videos lg:h-[315px] w-[460px]" src="https://www.youtube.com/embed/xz6YlRulM3A?si=StnMtUwU5zgXPB6z" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                  <iframe className="videos lg:h-[315px] w-[460px]" src="https://www.youtube.com/embed/xz6YlRulM3A?si=StnMtUwU5zgXPB6z" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                  <iframe className="videos lg:h-[315px] w-[460px]" src="https://www.youtube.com/embed/xz6YlRulM3A?si=StnMtUwU5zgXPB6z" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                  <iframe className="videos lg:h-[315px] w-[460px]" src="https://www.youtube.com/embed/xz6YlRulM3A?si=StnMtUwU5zgXPB6z" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
