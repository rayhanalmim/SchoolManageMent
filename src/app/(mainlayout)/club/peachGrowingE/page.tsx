...
import logo from "../../../../../public/assests/club/peach.png"
import debate1 from "../../../../../public/assests/club/peach2.png"
import debate2 from "../../../../../public/assests/club/peach3.jpg"
import debate3 from "../../../../../public/assests/club/peach4.jpg"
                                        ...
                                        <div className="grid gap-4 mx-1 md:mx-2 lg:mx-4 sm:grid-cols-12">
                                            <div className="col-span-12 sm:col-span-4">
                                                <div className="text-center sm:text-left mb-14 before:block before:w-24 before:h-3 before:mb-5 before:rounded-md before:mx-auto sm:before:mx-0 before:bg-violet-600">
                                                    <h3 className="text-3xl font-semibold">Peach Growing Education (HWPL)</h3>
                                            ...
                                            <div className="relative col-span-12 px-1 md:px-2 lg:px-4 space-y-6 sm:col-span-7 text-justify">
                                                <div className="col-span-12 space-y-12 relative px-1 md:px-2 lg:px-4 sm:col-span-8 sm:space-y-8 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:bg-gray-300">
                                                    <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-violet-600">
                                                        <h3 className="text-xl font-semibold tracking-wide">পিচ গ্রোয়িং এডুকেশন (এইচডব্লিউপিএল) প্রতিষ্ঠা</h3>
                                                        <time className="text-xs tracking-wide uppercase   text-gray-600">জানুয়ারী ২০১০</time>
                                                        <p className="mt-3">কেবল শ্রেণিপাঠ নয় শিক্ষার্থীদের সংস্কৃতি চর্চায় উদ্বুদ্ধ করে তাদের সুকুমার বৃত্তির বিকাশ বিকাশ ঘটানোও শিক্ষাপ্রতিষ্ঠানের অন্যতম দায়িত্ব। সঙ্গীত, কলা,নৃত্য, অংকন

                                                            ইত্যাদির চর্চায় শিক্ষার্থী নতুন কোনো রক্তিম ভুবনের সাথে আলিঙ্গন করতে সক্ষম হয়। এসব চর্চায় প্রতিষ্ঠানের শিক্ষার্থীরা খুব উৎফুল্ল হয়ে ওঠে। সংস্কৃতিমনা শিক্ষার্থী  গড়ে তুলতে আর্ট অ্যান্ড কালচারাল আত্মপ্রকাশ ঘটে। আর্ট অ্যান্ড কালচারাল ক্লাবের উদ্যোগে বার্ষিক সাংস্কৃতিক অনুষ্ঠান উদযাপিত হয়।</p>
                                                    </div>
                                                    <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-violet-600">
