                ...
                <div className="container max-w-6xl p-4 mx-auto space-y-6 sm:space-y-12">
                  <a rel="noopener noreferrer" href="#" className="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12  bg-gray-50">
                    ...
                    <div className=" space-y-2 lg:col-span-5  p-4">
                      <h3 className="font-bold text-xl md:text-xl lg:text-2xl group-hover:underline group-focus:underline lg:pt-5">Noster tincidunt reprimique ad pro</h3>
                  ...
                  <div className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    {eventsItems.map(items => (
                      <a key={items.title} rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline bg-gray-50">
                        <Image src={items.src} className="object-cover w-full rounded h-44 bg-gray-500" alt="" />
                        <div className="p-3 space-y-2">
                          <h3 className="text-xl font-semibold group-hover:underline group-focus:underline">{items.title}</h3>
                          <span className="text-xs text-gray-600">{items.date}</span>
