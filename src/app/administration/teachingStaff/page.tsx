              ...
              <section className="lg:w-auto border rounded p-4 bg-white text-gray-800">
                ...
                <div className="container  mx-auto lg:space-y-16 p-2 lg:p-4">
                  ...
                  <div className="flex gap-5">
                    <Image src={headteacher} className="h-[300px] " alt="img" />
                    <div className="text-justify">
                      <h1 className="font-bold text-3xl">মো. খুরশিদ আলম</h1>
                      <h2>প্রধান শিক্ষক</h2>
                      <h2>বিএসসি, বিএড, এমএড</h2>
